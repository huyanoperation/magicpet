...
- (IBAction) sendMsg:(NSData*) msg leng:(long) tag {
	...
	[client writeData:msg withTimeout:-1 tag:0];
...
- (void)onSocket:(AsyncSocket *)sock didConnectToHost:(NSString *)host port:(UInt16)port{
	[client readDataWithTimeout:-1 tag:0];
    CNet::onConnectToHost( [host UTF8String], port );
}

- (void)onSocket:(AsyncSocket *)sock willDisconnectWithError:(NSError *)err
{
    CNet::willDisconnectWithError();
    NSLog(@"Error");
}
...
- (void)onSocketDidDisconnect:(AsyncSocket *)sock
{
	...
	[msg release];
	client = nil;
    CNet::onSocketDidDisconnect();
}

- (void)disconnectAfterReadingAndWriting
{
    [client disconnectAfterReadingAndWriting];
}
