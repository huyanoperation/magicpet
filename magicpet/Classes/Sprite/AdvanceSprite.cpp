...
void AdvanceSprite::addFramesFromiT2D(const char *pList, int plistType)
{
    ...
    const char *pszPath = CCFileUtils::fullPathFromRelativePath(FulList.c_str());
...
//
//
void AdvanceSprite::PlayAnimation( int *pframeData, int number_Loop, SEL_CallFunc pfnSelectorDelegate, SelectorProtocol *pTarget, bool NeedToRunReverseAnimation, bool NeedToDeleteItself  )
{
...
void AdvanceSprite::scheduleDelete(ccTime tt)
{
