...
public:
    ...
    ***************************************************************************/
	...
	void PlayAnimation( int *pframeData, int number_Loop, SEL_CallFunc pfnSelectorDelegate, SelectorProtocol *pTarget, bool NeedToRunReverseAnimation, bool NeedToDeleteItself  );
